...
<sgcraft:naquadah>.addTooltip(format.lightPurple("the fabric of space and time. The Ancients used this"));
<sgcraft:naquadah>.addTooltip(format.lightPurple("property to power Stargates."));
...
<sgcraft:naquadahblock>.addTooltip(format.lightPurple("the chaotic forces involved in folding spacetime."));
