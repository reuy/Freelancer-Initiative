...
//Remove jungle tree extraction giving thermal latex
<recipeType:thermal:tree_extractor>.removeByName("thermal:devices/tree_extractor/tree_extractor_jungle");

//Make Tree extraction give foregoing latex instead
<recipetype:thermal:tree_extractor>.addJsonRecipe("tree_extractor_rubber_foregoing", {
